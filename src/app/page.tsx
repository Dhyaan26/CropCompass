...
import { ArrowRight, BarChartBig, Bug, Droplets, Landmark, LineChart, Trees, Bot, PoundSterling } from 'lucide-react';
...
export default function Home() {
  const { t } = useTranslation();
   ...
   const features = [
        ...
        { href: "/dashboard/market-price", icon: PoundSterling, text: t('tabs.marketPrice'), description: t('marketprice.description_short') },
